  ...
  mounted() {
    ...
    function animate() {
        if(animateHeader) {
            ...
            for(var i in points) {
                ...
                if(Math.abs(getDistance(target, points[i])) < 3500) {
                    points[i].active = 0.3;
                    points[i].circle.active = 0.6;
                } else if(Math.abs(getDistance(target, points[i])) < 17000) {
                    points[i].active = 0.1;
                    points[i].circle.active = 0.3;
                } else if(Math.abs(getDistance(target, points[i])) < 35000) {
    ...
    function drawLines(p) {
        ...
        for(var i in p.closest) {
            ...
            ctx.strokeStyle = 'rgba(70, 70, 235,'+ (p.active + 0.2) +')';
            ctx.stroke();
        }
    }
    ...
    function Circle(pos,rad,color) {
        ...
        this.draw = function() {
            ...
            ctx.fillStyle = 'rgba(70, 70, 235,'+ _this.active+')';
            ctx.fill();
        };
    }
